...
export default function TechHome() {
  ...
  return (
    ...
    >
      {/* hero band */}
      <Reveal>
        <section className="relative overflow-hidden rounded-xl border border-blurple/30 bg-gradient-to-br from-zinc-950 via-zinc-950 to-blurple/25 px-5 py-6 sm:px-7">

// ponytail: the entire ayush module lives HERE and nowhere else.
// rollback = delete this file + the guarded spreads marked [ayush] in
// score.js, quests.js, courses.js, quiz.js, interview.js, questionnaire.js,
// fdps.js, Jobs.jsx. no other file may import ayush nouns directly.
// kill switch: set AYUSH_ENABLED = false (or VITE_AYUSH=off) and every
// spread below dissolves. engine, scoring, and other tracks never branch.

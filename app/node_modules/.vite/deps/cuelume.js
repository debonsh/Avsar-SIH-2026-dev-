...
function play(sound = "chime", options) {
	...
	if (context.state === "running") renderRecipe(context, recipe, playVolume);
	else try {
		context.resume().then(() => {
...
//#endregion
export { bind, play, setEnabled, setVolume, sounds };

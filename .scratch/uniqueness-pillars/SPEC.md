...
> **Frozen copy, kept for the record.** This is the specification exactly as it was written,
> before implementation, including the four claims that turned out to be wrong. The corrected
> and current version is `avsar SIH 2026/temp/avsar-uniqueness-prd.md`; the plan that executed
> it is `PLAN.md` beside this file. Anywhere the two disagree, `PLAN.md` and the code are right.

    ...
    >
          ...
          <div className="mb-4 flex gap-1 rounded-xl border border-stone-200 bg-white p-1" role="tablist" aria-label="Resume steps">
            {TABS.map((t) => (
              <button
                ...
                onClick={() => setTab(t.id)}
                className={`min-h-[40px] flex-1 rounded-lg px-2 text-sm font-semibold transition-colors ${
      ...
      {stage === "congrats" && (
        <Card className="overflow-hidden text-center">
          <div className="mx-auto flex size-20 items-center justify-center rounded-full bg-emerald-700 font-display text-2xl font-bold text-white">
            100
          </div>
          <h2 className="mt-4 font-display text-2xl font-bold text-stone-900">First loop complete</h2>
          ...
          <div className="mt-6">
            <Btn onClick={startJourney} size="lg">Let&apos;s start your journey</Btn>
          </div>
        </Card>
      )}
    </Page>
